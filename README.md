...
* [`src/clj/portcard/`](src/clj/portcard/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/portcard/`](src/cljs/portcard/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/portcard/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/portcard/`](test/cljs/portcard/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
7. Clone this repo and open a terminal in the `portcard` project root directory
...
in the [`src/clj/portcard/`](src/clj/portcard/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/portcard/config.cljs) defaults to `true` in
...
```clj
(ns portcard.example
  (:require [portcard.config :as config])
